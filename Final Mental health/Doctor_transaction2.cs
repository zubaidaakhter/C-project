...
{
    public partial class Doctor_transaction2 : Form
    {
        string cs = ConfigurationManager.ConnectionStrings["sdb"].ConnectionString;
        public Doctor_transaction2()
        {
            InitializeComponent();
            BindGridView();
        }
        ...
        {
            exportgridtopdf(dataGridView1, "transaction history. ");
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Close();
                Doctor_homepage use5 = new Doctor_homepage();
                this.Hide();
                use5.ShowDialog();
                Application.Exit();
